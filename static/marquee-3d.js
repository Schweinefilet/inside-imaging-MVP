...
(function () {
    ...
    class Marquee3D {
        ...
        createStructure() {
            ...
            // Trigger overlay text fade-in
            const overlay = this.container.querySelector('.marquee-3d-overlay');
            if (overlay) {
                requestAnimationFrame(() => overlay.classList.add('marquee-overlay-visible'));
            }
        }
